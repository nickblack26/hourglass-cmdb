...
const Timeline = React.forwardRef<HTMLUListElement, TimelineProps>(({ children, className, positions, ...props }, ref) => {
	return (
...
const TimelineDot = React.forwardRef<HTMLDivElement, TimelineDotProps>(({ className, status, customIcon, ...props }, ref) => (
...
interface TimelineConent extends React.HTMLAttributes<HTMLParagraphElement>, VariantProps<typeof timelineContentVariants> {}
...
interface TimelineConent extends React.HTMLAttributes<HTMLParagraphElement>, VariantProps<typeof timelineHeadingVariants> {}

const TimelineHeading = React.forwardRef<HTMLParagraphElement, TimelineConent>(({ className, side, variant, ...props }, ref) => (
	<p
		role='heading'
