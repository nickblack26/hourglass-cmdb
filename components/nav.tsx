...
export function Nav({ isCollapsed }: NavProps) {
	...
	const navSections: NavSection[] = [
		...
		// { header: 'Conversation', links: worker?.reservations },
	...
	return (
		<nav data-collapsed={isCollapsed} className='group flex flex-col gap-3 p-2 data-[collapsed=true]:py-2 bg-neutral-100 h-screen'>
			...
			<ul className='grid h-full gap-1 group-[[data-collapsed=true]]:justify-center group-[[data-collapsed=true]]:px-3'>
				{reservations.map((reservation) => (
					<CallCard key={reservation.sid} reservation={reservation} isCollapsed={false} />
				))}
			</ul>
