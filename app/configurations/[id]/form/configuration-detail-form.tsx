...
const ConfigurationDetailForm = ({ configuration }: Props) => {
	...
	return (
		<Card>
			...
			<CardContent>
				<Form {...form}>
					<form onSubmit={form.handleSubmit(onSubmit)} id='configuration-detail-form' name='configuration-detail-form' className='space-y-8'>
						<FormField
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									>
										<CompanySelector onValueChange={field.onChange} defaultValue={field?.value?.toString() ?? undefined} />
									</Suspense>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									>
										<ContactSelector onValueChange={field.onChange} defaultValue={field.value?.toString() ?? undefined} />
									</Suspense>
			...
			<CardFooter className='border-t p-4'>
				<Button disabled={disabled} className='ml-auto' form='configuration-detail-form'>
					Save
				</Button>
			</CardFooter>
		</Card>
