	...
	return (
		<main>
			...
			<section className='grid grid-cols-4 gap-3 p-0'>
				<Metric title='Created Tickets' amount={ticketData.total_tickets.toString()} timeline='Compared to last month' percentage={1} />
				<Metric title='Unsolved Tickets' amount='24,208' timeline='Compared to last month' />
				<Metric title='Solved Tickets' amount='24,208' timeline='Compared to last month' />
				<Metric title='Average First Time Reply' amount={`${getTime(ticketData.avg_response_time)} mins`} timeline='Compared to last month' />
			</section>
					...
					<div className='grid grid-cols-2'>
						...
						<div className='space-y-1 border-b p-6'>
							...
							<div className='grid grid-cols-[1fr_24px] gap-3 place-items-center'>
								{/* @ts-ignore */}
								<Progress value={80} fill='bg-green-500' />
						...
						<div className='space-y-1 border-r p-6'>
							...
							<div className='grid grid-cols-[1fr_24px] gap-3 place-items-center'>
								{/* @ts-ignore */}
								<Progress value={15} fill='bg-yellow-500' />
						...
						<div className='space-y-1 p-6 '>
							...
							<div className='grid grid-cols-[1fr_24px] gap-3 place-items-center'>
								{/* @ts-ignore */}
								<Progress value={5} className='bg-neutral-100' fill='bg-red-500' />
