...
import { ArrowUpRight, ChevronLeft, PlusCircle, QrCode, Search, Upload } from 'lucide-react';
		...
		<main className='grid flex-1 items-start gap-4 p-4 sm:px-6 md:gap-8'>
			<div className='grid flex-1 auto-rows-max gap-4'>
				<div className='flex items-center gap-4'>
					...
					<h1 className='flex-1 shrink-0 whitespace-nowrap text-xl font-semibold tracking-tight sm:grow-0'>{configuration.name}</h1>
