...
const Page = async (props: any) => {
	...
	const { data: tickets } = await supabase.from('tickets').select().eq('contact', props.params.id);
						...
						<Suspense>
							<section className='space-y-3'>
								<div className='flex items-center justify-between'>
									...
									<Button variant='link'>
										<Link href={`/contacts/${props.params.id}/`}>View more tickets</Link>
									</Button>
								</div>
								{tickets
						...
						<section className='space-y-3'>
							<div className='flex items-center justify-between'>
								...
								<Button variant='link' asChild>
									<Link href={`/contacts/${props.params.id}/activity`}>View more activity</Link>
								</Button>
							</div>
