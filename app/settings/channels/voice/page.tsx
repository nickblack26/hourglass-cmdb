										...
										<TableRow key={queue.sid}>
											...
											<TableCell>
												...
												<Input
													...
													type='number'
													defaultValue={queue.maxReservedWorkers ?? undefined}
												/>
											</TableCell>
											<TableCell>
												<Label
												...
												<Textarea
													name='maxReservedWorkers'
													defaultValue={queue.targetWorkers ?? undefined}
												/>
											</TableCell>
											<TableCell>
												<div className='flex items-center gap-1.5'>
													...
													<Button
														...
														className='hover:bg-red-50 focus:bg-red-50'
													>
														<TrashIcon className=' h-3.5 text-red-500 ' />
													</Button>
												</div>
											</TableCell>
										</TableRow>
										...
										<TableRow key={workflow.sid}>
											...
											<TableCell>
												...
												<Input
													name='maxReservedWorkers'
													type='number'
													defaultValue={workflow.timeoutActivityName ?? undefined}
												/>
											</TableCell>
											<TableCell>
												<Label
												...
												<Textarea
													name='maxReservedWorkers'
													defaultValue={workflow.accountSid ?? undefined}
												/>
											</TableCell>
											<TableCell>
												<div className='flex items-center gap-1.5'>
					...
					<CardContent className='grid grid-cols-4 gap-3'>
						{workers &&
							...
							workers?.map((worker: Worker) => (
								<div
									key={worker.sid}
									className='flex items-center gap-3 justify-around'
								>
									<div>
										<h4>{worker.friendlyName}</h4>
									</div>
									<Badge variant={worker.available ? 'green' : 'secondary'}>
